...
## Reading
- Read only the inbound message, the feature/IR, and the contracts your role names. Do not re-read your role prompt or the constitution. Do not read `CONVERSION.md`. `uncle_bob_swarmforge_reference/` is a read-only reference; do not explore it for task work.
